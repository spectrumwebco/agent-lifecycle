...
func TestNormalizeRepository(t *testing.T) {
	testCases := []testCaseNormalizeRepository{
		{
			in:                  "ssh://github.com/spectrumwebco/kled-beta.git",
			expectedRepo:        "ssh://github.com/spectrumwebco/kled-beta.git",
			expectedPRReference: "",
			expectedBranch:      "",
			expectedCommit:      "",
			expectedSubpath:     "",
		...
		{
			in:                  "ssh://git@github.com/spectrumwebco/kled-beta.git",
			expectedRepo:        "ssh://git@github.com/spectrumwebco/kled-beta.git",
			expectedPRReference: "",
			expectedBranch:      "",
			expectedCommit:      "",
			expectedSubpath:     "",
		...
		{
			in:                  "https://github.com/spectrumwebco/kled-beta.git",
			expectedRepo:        "https://github.com/spectrumwebco/kled-beta.git",
			expectedPRReference: "",
			expectedBranch:      "",
			expectedCommit:      "",
			expectedSubpath:     "",
		...
		{
			in:                  "github.com/spectrumwebco/kled-beta.git",
			expectedRepo:        "https://github.com/spectrumwebco/kled-beta.git",
			expectedPRReference: "",
			expectedBranch:      "",
			expectedCommit:      "",
		...
		{
			in:                  "github.com/spectrumwebco/kled-beta.git@test-branch",
			expectedRepo:        "https://github.com/spectrumwebco/kled-beta.git",
			expectedPRReference: "",
		...
		{
			in:                  "github.com/spectrumwebco/kled-beta-without-protocol-with-slash.git@user/branch",
			expectedRepo:        "https://github.com/spectrumwebco/kled-beta-without-protocol-with-slash.git",
			expectedPRReference: "",
		...
		{
			in:                  "github.com/spectrumwebco/kled-beta.git@sha256:905ffb0",
			expectedRepo:        "https://github.com/spectrumwebco/kled-beta.git",
			expectedPRReference: "",
			expectedBranch:      "",
		...
		{
			in:                  "github.com/spectrumwebco/kled-beta.git@pull/996/head",
			expectedRepo:        "https://github.com/spectrumwebco/kled-beta.git",
		...
		{
			in:                  "github.com/spectrumwebco/kled-beta-without-protocol-with-slash.git@subpath:/test/path",
			expectedRepo:        "https://github.com/spectrumwebco/kled-beta-without-protocol-with-slash.git",
			expectedPRReference: "",
			expectedBranch:      "",
			expectedCommit:      "",
		...
		{
			in:                  "https://my_prefix@github.com/spectrumwebco/kled-beta.git@test-branch",
			expectedRepo:        "https://my_prefix@github.com/spectrumwebco/kled-beta.git",
			expectedPRReference: "",
			expectedBranch:      "test-branch",
			expectedCommit:      "",
			expectedSubpath:     "",
