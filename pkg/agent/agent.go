...
const defaultAgentDownloadURL = "https://github.com/spectrumwebco/kled-beta/releases/download/"
...
func DefaultAgentDownloadURL() string {
	...
	if version.GetVersion() == version.DevVersion {
		return "https://github.com/spectrumwebco/kled-beta/releases/latest/download/"
	}
