...
from apps.agent.agent_framework import PACKAGE_NAME, REMOTE_EXECUTABLE_NAME
from apps.agent.agent_framework.deployment.abstract import AbstractDeployment
from apps.agent.agent_framework.deployment.config import DockerDeploymentConfig
from apps.agent.agent_framework.deployment.hooks.abstract import (
    CombinedDeploymentHook,
    DeploymentHook,
)
from apps.agent.agent_framework.exceptions import (
    DeploymentNotStartedError,
    DockerPullError,
)
from apps.agent.agent_framework.runtime.abstract import IsAliveResponse
from apps.agent.agent_framework.runtime.config import RemoteRuntimeConfig
from apps.agent.agent_framework.runtime.remote import RemoteRuntime
from apps.agent.agent_framework.utils.free_port import find_free_port
from apps.agent.agent_framework.utils.log import get_logger
from apps.agent.agent_framework.utils.wait import _wait_until_alive
...
class DockerDeployment(AbstractDeployment):
    ...
    def _get_agent_framework_start_cmd(self, token: str) -> list[str]:
    ...
    async def start(self):
        ...
        cmds = [
            ...
            *self._config.docker_args,
            ...
            image_id,
            *self._get_agent_framework_start_cmd(token),
        ]
