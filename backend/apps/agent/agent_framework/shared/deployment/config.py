...
class LocalDeploymentConfig(BaseModel):
    ...
    def get_deployment(self) -> AbstractDeployment:
        from apps.agent.agent_framework.deployment.local import LocalDeployment
...
class DockerDeploymentConfig(BaseModel):
    ...
    def get_deployment(self) -> AbstractDeployment:
        from apps.agent.agent_framework.deployment.docker import DockerDeployment
...
class ModalDeploymentConfig(BaseModel):
    ...
    def get_deployment(self) -> AbstractDeployment:
        from apps.agent.agent_framework.deployment.modal import ModalDeployment
...
class FargateDeploymentConfig(BaseModel):
    ...
    def get_deployment(self) -> AbstractDeployment:
        from apps.agent.agent_framework.deployment.fargate import (
            FargateDeployment,
        )
...
class RemoteDeploymentConfig(BaseModel):
    ...
    def get_deployment(self) -> AbstractDeployment:
        from apps.agent.agent_framework.deployment.remote import RemoteDeployment
...
class DummyDeploymentConfig(BaseModel):
    ...
    def get_deployment(self) -> AbstractDeployment:
        from apps.agent.agent_framework.deployment.dummy import DummyDeployment
