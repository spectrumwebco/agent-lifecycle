...
import { ManagementV1KledWorkspaceInstance } from "@loft-enterprise/client/gen/models/managementV1DevPodWorkspaceInstance"
...
): Promise<Result<{ workspaceID: string; instance: ManagementV1KledWorkspaceInstance }>> {
  const instance = NewResource(Resources.ManagementV1KledWorkspaceInstance)
